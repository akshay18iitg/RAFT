...
def main():
    ...
    parser.add_argument('--name', type=str, default='RAFT-PIV32_training',
    ...
    parser.add_argument('--train_tfrecord', type=str,
                        default='./data/minimal_training_dataset_ProbClass1_32px.tfrecord-00000-of-00001',
                        help='TFRECORD file for training')
    parser.add_argument('--train_tfrecord_idx', type=str,
                        default='./data/idx_files/minimal_training_dataset_ProbClass1_32px.idx',
    ...
    parser.add_argument('--val_tfrecord', type=str,
                        default='./data/minimal_validation_dataset_ProbClass1_32px.tfrecord-00000-of-00001',
                        help='TFRECORD file for validation')
    parser.add_argument('--val_tfrecord_idx', type=str,
                        default='./data/idx_files/minimal_validation_dataset_ProbClass1_32px.idx',
