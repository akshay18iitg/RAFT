...
def train(GPU,args):
    ...
    with torch.set_grad_enabled(False):
        ...
        for i_batch, sample_batched in test_pbar:
            ...
            if args.test_dataset == 'tbl' or args.test_dataset == 'twcf':
            ...
            if args.plot_results:
                if args.test_dataset == 'twcf':
                    ...
                    cbar = plt.colorbar()
                    cbar.ax.set_ylabel('displacement [px]', fontsize=14)
                    t = plt.text(0, 225, 'RAFT256-PIV', fontsize=16)
                    t.set_bbox(dict(facecolor='white', alpha=1, edgecolor='white'))
                    plt.subplot(2, 2, 2)
                    ...
                    cbar = plt.colorbar()
                    cbar.ax.set_ylabel('displacement [px]', fontsize=14)
                    t = plt.text(0, 238, 'RAFT256-PIV', fontsize=16)
