...
`registry.codeocean.com/published/afee4103-9aa6-46de-a4ec-94ef5823cd8e:v1`
...
docker run --platform linux/amd64 --rm --gpus all \
  ...
  registry.codeocean.com/published/afee4103-9aa6-46de-a4ec-94ef5823cd8e:v1 bash run
```
